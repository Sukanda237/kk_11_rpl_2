                        ...
                        <tr>
                            ...
                            <td>
                                <center>
                                    ...
                                    <a onclick="return confirm('Apakah yakin data akan di hapus?')" href="?id=<?= $data->id_user ?>&aksi=hapus"><button type="button" name="hapus" class="btn btn-round btn-danger">Hapus</button></a>
                                </center>
                            </td>
                        </tr>
                    <?php endforeach; ?>
