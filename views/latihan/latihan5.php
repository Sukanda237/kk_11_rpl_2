...
<div class="container">
    ...
    <div class="row align-items-center">
        ...
        <div class="col-10">
            <center>
                <h3>Latiahan Menampilkan Data Dari Tabel User Dan Tampilkan Data User Yang Memiliki Alamat Di Jalan Merdeka</h3>
            </center><br>
            <table class="table ">
                <thead>
                    <thead>
                ...
                <tbody>
                    ...
                    foreach ($latihan->tampil_data2() as $data) :
                        ...
                        if (stripos($data->alamat_user, 'Merdeka') !== false) {
